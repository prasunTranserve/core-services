...
public class SMSServices {
	...
	public String sendOtpSMS(String username, String password, String message, String senderId, String mobileNumber,
			String secureKey, String templateid) {
	...
	public String sendUnicodeOtpSMS(String username, String password, String message, String senderId,
			String mobileNumber, String secureKey, String templateid) {
	 ...
	 * 
	 * @param message e.g. 'à¤µà¤¿à¤à¤¾à¤¸ à¤à¤£à¤¿ à¤ªà¥à¤°à¤à¤¤
	...
	// 	// sendSingleSMS("opscsms2012-ODIGOV_HUDSUJOG", "Sujog$78901", "Dear <1> Your Application for <2> (Service type) is created. Please use the Application number <3> for future reference. Govt. of Odisha", "ODIGOV", "8686574377",
	// 	// 		"8ace3c4f-9581-4392-b01d-c6d152872e1d", "1007114894859783166");
	// 	sendSingleSMS("opscsms2012-ODIGOV_HUDSUJOG", "Sujog$78901", "Dear <1> Your Application for <2> (Service type) is created. Please use the Application number <3> for future reference. Govt. of Odisha", "ODIGOV", "9836593551",
	// 			"8ace3c4f-9581-4392-b01d-c6d152872e1d", "1007114894859783166");
	// }

	/*
	 * public static void main(String[] args) { String message =
	 * "I love you <<>> ID#1234567891011121314"; String[] strings =
	 * message.split("ID#"); System.out.println(strings.length); if (strings !=
	 * null) { if (strings.length == 1) { String s1 = strings[0]; String s2 =
	 * strings[1];
	 * 
